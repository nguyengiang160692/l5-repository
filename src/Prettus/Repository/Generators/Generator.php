...
abstract class Generator
{
    ...
    public function getModule()
    {
        ...
        return Str::studly(str_replace(' ', '/', ucwords(str_replace('/', ' ', $module))));
    }
   ...
   /**
    ...
    {
        return config('repository.generator.rootNamespace', $this->getAppNamespace()). '\\' . $this->getModule() . '\\';
    }
